...
class vrp_by_geopy_class:
    ...
    def add_client_to_df_dist_sorted(self,client,cord):
        ...
        return new_client
    #
    def add_clien_to_vrp(self,vrp_sol,client,avnc,cord):
      #
      m=[]
      #
      dict_dis=self.add_client_to_df_dist_sorted(client,cord)
      #
      for i,x in enumerate(vrp_sol):
        ...
        #
      index=min(m)
      clients=list(vrp_sol[index[3]].values())[0]
      sorted_list=self.ajout(clients,client,index[4])
      #
      vrp_sol[index[3]][index[2]]=sorted_list
      #
      return vrp_sol
...
if __name__ == '__main__':
    ...
    #
    avc=[{'k':2},{'k':8},{'k':3},{'k':5}]
    print(tour.add_clien_to_vrp(vrp_dict_affec,'abdouy',avc,(12,15)))
    #